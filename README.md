...
This project enhances the Student Management System by adding exception handling, custom exceptions, multithreading, and wrapper classes.
It ensures safe user input, prevents crashes, and provides a responsive experience using a loading simulation thread.
...
2. StudentNotFoundException (Custom Exception)

Thrown when a student is not found during search.

3. Loader (implements Runnable)
...
5. StudentManager (implements RecordActions)
